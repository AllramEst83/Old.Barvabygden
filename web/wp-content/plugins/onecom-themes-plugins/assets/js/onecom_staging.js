(function ($)
{
	...
	*/
	...
	$('.one-button-update-staging').click( function() {
		...
		var cu_journey_event  = $(this).attr('data-cu-confirm-journey-event');

		tb_show(title, "#TB_inline?width=" + width + "&height=" + height + "&inlineId=" + id + "&modal=true&class=thickbox", null);
		$('#TB_window').css({'margin-left':'-' + parseInt((width / 2),10) + 'px','top':'50%','margin-top': '-' + parseInt((height / 2),10) + 'px'});
		$('#TB_window #TB_ajaxContent').find('.confirm-done').addClass(cu_journey_event);
	...
	$('.one-button-delete-staging').click( function() {
		...
		tb_show(title, "#TB_inline?width=" + width + "&height=" + height + "&inlineId=" + id + "&modal=true&class=thickbox", null);
		$('#TB_window').css({'height':'250px','margin-left':'-' + parseInt((width / 2),10) + 'px','top':'50%','margin-top': '-' + parseInt((height / 2),10) + 'px'});
		$('#TB_window #TB_ajaxContent').find('.confirm-done').addClass(cu_journey_event);
	} );
	...
	$('.one-button-copy-to-live').click( function() {
		...
		tb_show(title, "#TB_inline?width=" + width + "&height=" + height + "&inlineId=" + id + "&modal=true&class=thickbox", null);
		$('#TB_window').css({'height':'275px','margin-left':'-' + parseInt((width / 2),10) + 'px','top':'50%','margin-top': '-' + parseInt((height / 2),10) + 'px'});
		$('#TB_window #TB_ajaxContent').find('.confirm-done').addClass(cu_journey_event);
	} );
